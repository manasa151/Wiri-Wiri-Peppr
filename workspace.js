...
cprequire_test(["inline:com-chilipeppr-workspace-wiri-wiri-pepper"], function(ws) {
    ...
    $('title').html("wiri-wiri-pepper Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-wiri-wiri-pepper", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-wiri-wiri-pepper", // Make the id the same as the cpdefine id
        name: "Workspace / wiri-wiri-pepper", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace wiri-wiri-pepper.`,
