# com-chilipeppr-workspace-wiri-wiri-pepper
A ChiliPeppr Workspace wiri-wiri-pepper.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / wiri-wiri-pepper
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-wiri-wiri-pepper |
| Name                  | Workspace / wiri-wiri-pepper |
| Description           | A ChiliPeppr Workspace wiri-wiri-pepper. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/manasa151/Wiri-Wiri-Peppr/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/cornerstoneconnections/wiri-wiri-pepper |
| Github URL            | http://github.com/manasa151/Wiri-Wiri-Peppr |
| Test URL              | https://preview.c9users.io/cornerstoneconnections/wiri-wiri-pepper/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/manasa151/Wiri-Wiri-Peppr/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-wiri-wiri-pepper"], // the id you gave your workspace
      function(myWorkspaceWiriWiriPepper) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / wiri-wiri-pepper just got loaded.", myWorkspaceWiriWiriPepper);
        myWorkspaceWiriWiriPepper.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-wiri-wiri-pepper"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / wiri-wiri-pepper"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace wiri-wiri-pepper."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/manasa151/Wiri-Wiri-Peppr/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/cornerstoneconnections/wiri-wiri-pepper"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/manasa151/Wiri-Wiri-Peppr"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://wiri-wiri-pepper-cornerstoneconnections.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
